	...
	; Compiler options:
	;
	; -oms83f080_dcmotor.cof -mms83f080_dcmotor.map --summary=default \
	; --output=default main.p1 myadc.p1 myconfiguration.p1 mykey.p1 \
	; mypwm.p1 --chip=16F685 -P --runtime=default --opt=default -D__DEBUG=1 \
